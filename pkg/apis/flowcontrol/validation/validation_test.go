...
func TestFlowSchemaValidation(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			expectedErrors: field.ErrorList{
				field.Invalid(field.NewPath("spec").Child("matchingPrecedence"), int32(0), "must be positive value"),
...
func TestPriorityLevelConfigurationValidation(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			priorityLevelConfiguration: &flowcontrol.PriorityLevelConfiguration{
				ObjectMeta: metav1.ObjectMeta{
					Name: flowcontrol.SystemPriorityLevelConfigurationNameLow,
				},
				Spec: flowcontrol.PriorityLevelConfigurationSpec{
					GlobalDefault:            true,
					Exempt:                   false,
		...
		},
		{
			...
			priorityLevelConfiguration: &flowcontrol.PriorityLevelConfiguration{
				ObjectMeta: metav1.ObjectMeta{
					Name: flowcontrol.SystemPriorityLevelConfigurationNameTop,
				},
				Spec: flowcontrol.PriorityLevelConfigurationSpec{
					GlobalDefault:            false,
					Exempt:                   true,
		...
		},
		{
			...
			expectedErrors: field.ErrorList{
				...
				field.Invalid(field.NewPath("spec").Child("handSize"), int32(0), "must be positive"),
		...
		},
		{
			...
			expectedErrors: field.ErrorList{
				field.Invalid(field.NewPath("spec").Child("handSize"), int32(8), "falling factorial of handSize (8) and queues (512) exceeds 64 bits"),
			},
		},
		{
			...
			expectedErrors: field.ErrorList{
				field.Invalid(field.NewPath("spec").Child("handSize"), int32(10), "falling factorial of handSize (10) and queues (128) exceeds 64 bits"),
			},
		},
		{
			...
			expectedErrors: field.ErrorList{
				field.Invalid(field.NewPath("spec").Child("handSize"), int32(3), "falling factorial of handSize (3) and queues (2147483647) exceeds 64 bits"),
			},
		},
		{
