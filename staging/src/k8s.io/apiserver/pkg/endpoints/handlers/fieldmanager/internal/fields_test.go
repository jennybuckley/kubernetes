...
func BenchmarkSetToFields(b *testing.B) {
	set := fieldpath.NewSet(
		...
		fieldpath.MakePathOrDie("qux", fieldpath.KeyByFields("name", value.Reflect("first"))),
		fieldpath.MakePathOrDie("qux", fieldpath.KeyByFields("name", value.Reflect("first")), "bar"),
		fieldpath.MakePathOrDie("qux", fieldpath.KeyByFields("name", value.Reflect("second")), "bar"),
	)
